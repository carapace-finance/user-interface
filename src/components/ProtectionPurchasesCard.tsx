    ...
    <div className="rounded-2xl shadow-lg shadow-gray-200 p-3 w-full mb-5">
      <div className="flex justify-between">
        <div>
          ...
          <p className="text-sm">
            {getLendingPoolName(
              props.protectionPurchasesData.lendingPoolAddress
            )}
          </p>
        </div>
        <div className="ml-3">
      ...
      <div className="flex justify-between mt-3 mb-4">
        <div>
          ...
          <p className="text-sm">
            {numeral(
              convertUSDCToNumber(
                props.protectionPurchasesData.protectionAmount
              )
            )
              .format(USDC_FORMAT)
              .toString()}
        ...
        <div>
          ...
          <p className="text-sm">
            {unixtimeDiffFromNow(
              props.protectionPurchasesData.expirationTimestamp.toNumber()
            )}
          </p>
        </div>
      </div>
      <div className="flex justify-between">
        <div>
          ...
          <p className="text-sm">
            {numeral(
              convertUSDCToNumber(
                props.protectionPurchasesData.protectionPremium
              )
            )
              .format(USDC_FORMAT)
              .toString()}
